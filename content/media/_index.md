...
{{< gallery >}}
  {{< figure src="img/screenshots/earth.jpg" caption="A view of the Earth in Gaia Sky." >}}
  {{< figure src="img/screenshots/asteroids.jpg" caption="A view of the Asteroids in the Gaia FPR dataset." >}}
  ...
  {{< figure src="img/screenshots/iss.jpg" caption="The International Space Station from above." >}}
  ...
  {{< figure src="img/screenshots/sunset.jpg" caption="The Earth and the Sun in a breathtaking scene." >}}
  ...
  {{< figure src="img/screenshots/earthgal.jpg" caption="The Milky Way and Earth." >}}

  {{< figure src="img/screenshots/datasets.jpg" caption="The datasets pane in Gaia Sky." >}}
  {{< figure src="img/screenshots/orion.jpg" caption="The Orion capsule from the Artemis missions." >}}
{{< /gallery >}}
