...
const selectedIcons = {
    "mdi": ['vr', 'file-transfer-outline', 'script-text-outline', 'arrow-left-bold', 'arrow-right-bold', 'linux', 'git', 'debian', 'fedora', 'arch', 'zip-box', 'code', 'tag', 'clock-time-four', 'calendar', 'grid', 'stars', 'cube', 'orbit', 'cloud', 'email', 'rss', 'twitter'],
    "fa": ['search', 'apple'],
